package com.cricketlive.api.crickinformer.impl;

import com.cricketlive.api.crickinformer.Entities.Match;
import com.cricketlive.api.crickinformer.repositories.MatchRepo;
    ...
    public List<Match> getLiveMatches() {
        ...
        try {
            ...
            for (Element match : liveScoreElements) {
                ...
                match1.setBattingTeamScore(battingTeamScore);
